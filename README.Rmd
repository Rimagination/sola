...
The goal of `sola` is to provide tools for solar resource assessment and utilization. The package implements functions for calculating solar radiation based on daylight hours, latitude, and other related parameters. The main advantage of `sola` is the use of vectorized operations, allowing efficient computation of large datasets.
...
The `sola` package can efficiently process large datasets. Here's an example of estimating solar radiation for multiple locations and dates:
